...
caminho_relatos = "src/dados/relatos_pacientes.txt"
...
mapa_dados = [
    ...
    [
        ...
        "formigamento ou fraqueza súbita em um lado do corpo",
        "Cerebrovascular",
    ],
    ["confusão mental súbita", "fala arrastada", "Cerebrovascular"],
    [
        "coloração roxa ou azulada na pele",
    ...
    [
        "dores nas articulações e no músculo",
        "inchaço nos pés, pernas ou barriga",
        "Endocardite",
    ],
    ["sopro cardíaco", "dispneia", "Endocardite"],
    [
        "dor no peito ao esforço emocional",
        "desconforto torácico sob estresse",
        "Angina",
    ],
    [
        "dor que melhora com repouso",
        "desconforto ao esforço e alívio ao descanso",
        "Angina",
    ],
    ...
    [
        "dificuldade de ganhar peso desde o nascimento",
    ...
    [
        "fadiga constante com perda de apetite",
...
df_mapa = pd.DataFrame(
    mapa_dados, columns=["Sintoma 1", "Sintoma 2", "Doença Associada"]
)
caminho_mapa = "src/dados/mapa_sintomas_doencas.csv"
